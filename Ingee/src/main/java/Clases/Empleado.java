...
public class Empleado {
    ...
    public Empleado(int id, String nombre, long telefono, float sueldo, List<Trabajo> trabajos, List<Retiro> retiros) {
        this.id = id;
        this.nombre = nombre;
    ...
    public long getTelefonoEmpleado() { return telefono; }
    public void setTelefonoEmpleado(long telefono) { this.telefono = telefono; }
